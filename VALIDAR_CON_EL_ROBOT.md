...
|---|---|---|---|---|
| **4-1** | abrir `/robot/7` con el agente parado | dice que **no llega al agente**, y que eso es **otro enlace** que el de la franja de arriba | 🟡 **el navegador, a medias** (2026-08-15): la frase de los dos enlaces sale palabra por palabra, con la franja diciendo «en línea» y el terminal negándose. Falta verlo **con el agente parado de verdad** | que diga «en línea» a secas: son dos sockets a dos puertos, y uno vivo no dice nada del otro |
...
| **4-10** | dos pestañas, dos usuarios, mismo robot | el segundo ve **quién** lo tiene y desde cuándo, y **no** puede quitárselo | 🔴 **el navegador — Y FALLÓ** (2026-08-15). El segundo **no** podía quitárselo (el agente rechazó su «parar» y el programa siguió vivo), pero su pantalla decía **«Ya tienes un programa corriendo. Párralo antes.»** sobre el programa ajeno, con su PID. Arreglado en las dos mitades; ⏳ **falta repetirlo con rvr-01 actualizado** | un «ocupado» sin nombre: con dos robots por mesa, el nombre es la diferencia entre esperar y preguntar |
